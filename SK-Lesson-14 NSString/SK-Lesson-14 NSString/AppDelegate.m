...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSRange rangeOne = [string rangeOfString:@"world"];

    NSLog(@"%ld", rangeOne.location);
    NSLog(@"%ld", NSNotFound);
    
    // Search in NSString
    
    if (rangeOne.location != NSNotFound) {
        NSLog(@"range = %@", NSStringFromRange(rangeOne));
    } else {
        NSLog(@"not found");
    }

    NSRange rangeTwo = [string rangeOfString:@"world" options:NSCaseInsensitiveSearch | NSBackwardsSearch];

    if (rangeTwo.location != NSNotFound) {
        NSLog(@"range = %@", NSStringFromRange(rangeTwo));
    } else {
        NSLog(@"not found");
    }
    ...
    // Let's count the word "NSString" in text
    ...
    text = [wordsArray componentsJoinedByString:@"_"];
