...
- (NSArray*)generateSectionsFromArray:(NSArray*) array withFilter:(NSString*) filterString
{
    ...
    for (NSString* string in array)
    {
        ...
        DSSection* section = nil;
        
        if (![currentLetter isEqualToString:firstLetter])
        {
            section = [[DSSection alloc] init];
...
- (NSArray *)sectionIndexTitlesForTableView:(UITableView *)tableView
{
    ...
    for (DSSection* section in self.sectionsArray)
    {
...
{
    DSSection* sec = [self.sectionsArray objectAtIndex:section];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    DSSection* section = [self.sectionsArray objectAtIndex:indexPath.section];
