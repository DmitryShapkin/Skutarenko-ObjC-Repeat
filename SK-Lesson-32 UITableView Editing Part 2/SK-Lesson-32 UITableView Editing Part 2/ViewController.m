...
- (void) actionAddSection:(UIBarButtonItem*) sender
{
    ...
    group.students = @[[DSStudent randomStudent], [DSStudent randomStudent]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        ...
        DSStudent* student = [group.students objectAtIndex:indexPath.row - 1];
...
- (void)tableView:(UITableView *)tableView moveRowAtIndexPath:(NSIndexPath *)sourceIndexPath toIndexPath:(NSIndexPath *)destinationIndexPath
{
    ...
    DSStudent* student = [sourceGroup.students objectAtIndex:sourceIndexPath.row - 1];
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (editingStyle == UITableViewCellEditingStyleDelete)
    {
        ...
        DSStudent* student = [sourceGroup.students objectAtIndex:indexPath.row - 1];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 0)
    {
        ...
        [tempArray insertObject:[DSStudent randomStudent] atIndex:newStudentIndex];
